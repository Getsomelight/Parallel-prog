...
Ниже представлено среднее время выполнения (в секундах) для разных размеров матриц и числа потоков OpenMP.
...
- Максимальное ускорение (≈3,8x) достигнуто для матрицы 2000*2000 при переходе с 1 потока на 8 потоков.
